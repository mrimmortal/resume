...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <p><?php echo $this->session->flashdata('RDetail'); ?></p>
    <p><?php echo $this->session->flashdata('ApplySucess'); ?></p> 
    <p><?php echo $this->session->flashdata('Applyfaild'); ?></p> 

      <h1>Hello <h3><?php echo $this->session->userdata('FirstName');?> <?php echo $this->session->userdata('LastName');?>
      </h3> </h1>
       <div class="scroll">
    ...
    <p>Letest News</p>
        ...
        foreach ($info as $drive_data) 
         {?>
            <div class="well">
              <p>
      <?php
      echo '<br>Drive Name<br>'.$drive_data->dname.
      ...
      echo '<a class="btn btn-primary" href="'.base_url().'home/apply/'.$drive_data->d_id.'/'.$this->session->userdata('Crid').'">Apply</a>';
              ?>
              </p>
...
<div class="modal fade" id="registrationmodal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
    ...
    <div class="col-sm-2 sidenav">
      <span class="badge" style="background-color:#ff0000"> Submit Your Resume Details Here.</span>
      <div class="well">
        <p><a class="btn btn-info" style="background-color:#008000" href="<?php echo base_url()."home/applicationform"?>" >APPLY</a></p>
      </div>
<!--       <span class="badge" style="background-color:#ff0000"> Give Your Test.</span>
      <div class="well">
        <p><a class="btn btn-info" style="background-color:#008000"  href="<?php echo base_url()."home/testdisplay"?>" >TEST</a></p>
      </div> -->
    </div>
  </div>
</div>
